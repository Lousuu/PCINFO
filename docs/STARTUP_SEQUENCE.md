...
- Full uses 360 ms Index, 205 ms row starts, 1220 ms Route, 360 ms Bind, 750 ms Lock, and 360 ms Reveal. Standard uses 300/120/720/220/500/270 ms. Reduced uses 120 ms Index and 180 ms Lock; Off has no visual clock. The next row starts only after the prior row's 145–205 ms Lower connection is complete.
...
- Runtime coverage includes 1107×685, 1120×720, 1600×900, 36/48/72 DIP, same-Y/up/down routes, 0.5 DIP alignment, reveal late snapshots, delayed Clips, route continuity, ports, real-service Index ordering, value coalescing, PollingVersion reset, Projection-to-COMMIT, and readiness settle. The suite total is `1717`; administrator EXE and manual visual/DPI acceptance were not run.
- Final isolated Release, Debug, and test builds are 0 warnings / 0 errors. Two independent Release executions are both `1717 / 0 / 1717` with empty stderr. CI remains attached to the existing open Draft PR #9; no merge, tag, or Release is part of this sequence.
