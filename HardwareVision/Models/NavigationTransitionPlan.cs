    ...
    public static NavigationTransitionPlan Create(MotionProfile profile)
    {
        ...
        return profile.EffectiveLevel switch
        {
            MotionLevel.Full => new(
                ...
                TimeSpan.FromMilliseconds(120), 0.18d, 6d,
                TimeSpan.FromMilliseconds(24), TimeSpan.FromMilliseconds(96), 0.26d, 5d,
                TimeSpan.Zero, TimeSpan.FromMilliseconds(88), 0.12d, 8d,
                TimeSpan.FromMilliseconds(220), 0.18d, 8d,
                TimeSpan.FromMilliseconds(20), TimeSpan.FromMilliseconds(180), 0.26d, 6d,
                TimeSpan.FromMilliseconds(66), TimeSpan.FromMilliseconds(190), 0.12d, 10d,
            ...
            MotionLevel.Standard => new(
                ...
                TimeSpan.FromMilliseconds(90), 0.26d, 4d,
                TimeSpan.FromMilliseconds(16), TimeSpan.FromMilliseconds(74), 0.36d, 4d,
                TimeSpan.Zero, TimeSpan.FromMilliseconds(66), 0.20d, 6d,
                TimeSpan.FromMilliseconds(160), 0.26d, 6d,
                TimeSpan.FromMilliseconds(14), TimeSpan.FromMilliseconds(138), 0.36d, 4d,
                TimeSpan.FromMilliseconds(44), TimeSpan.FromMilliseconds(146), 0.20d, 7d,
                true, true, true, true, true, true, true,
