...
public sealed class GameFrameValidationPipeline
{
    ...
    private GameFrameSample SanitizeMetrics(GameFrameSample sample, SwapChainCandidate candidate)
    {
        ...
        return new GameFrameSample
        {
            ...
            ApplicationFrameTimeMs = sample.ApplicationFrameTimeMs,
            PresentedFrameTimeMs = sample.PresentedFrameTimeMs,
            DisplayFrameTimeMs = sample.DisplayFrameTimeMs,
            ApplicationFps = sample.ApplicationFps,
            PresentedFps = sample.PresentedFps,
            DisplayedFps = sample.DisplayedFps,
            PrimaryFps = sample.PrimaryFps ?? 1000d / sample.FrameTimeMs.Value,
