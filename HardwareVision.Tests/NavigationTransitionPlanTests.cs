...
internal static class NavigationTransitionPlanTests
{
    ...
    private static void FullTiming()
    {
        ...
        TestSupport.Equal(TimeSpan.FromMilliseconds(190), plan.CommitTime, "Full decorative relay");
        ...
        TestSupport.Equal(plan.PageExitDuration, plan.ExitDuration, "Full outgoing lifetime");
    }
    ...
    private static void StandardTiming()
    {
        ...
        TestSupport.Equal(TimeSpan.FromMilliseconds(140), plan.CommitTime, "Standard decorative relay");
        TestSupport.Equal(plan.PageExitDuration, plan.ExitDuration, "Standard outgoing lifetime");
    }
    ...
    private static void ReducedTiming()
    {
        ...
        TestSupport.Equal(TimeSpan.FromMilliseconds(50), plan.CommitTime, "Reduced decorative relay");
    }
