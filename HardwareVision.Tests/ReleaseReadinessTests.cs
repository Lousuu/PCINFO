...
internal static class ReleaseReadinessTests
{
    ...
    [
        ("Release contract 01 Version is 2.0.2", () => PropertyIs("Version", "2.0.2")),
        ("Release contract 02 AssemblyVersion is 2.0.2.0", () => PropertyIs("AssemblyVersion", "2.0.2.0")),
        ("Release contract 03 FileVersion is 2.0.2.0", () => PropertyIs("FileVersion", "2.0.2.0")),
        ("Release contract 04 InformationalVersion is 2.0.2", () => PropertyIs("InformationalVersion", "2.0.2")),
        ...
        ("Release contract 40 release title contract", () => TestSupport.Equal("HardwareVision v2.0.2", $"HardwareVision v{Property("Version")}", "release title"))
    ];
